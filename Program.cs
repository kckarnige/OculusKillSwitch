...
static class Program
{
    ...
    static void Main()
    {
        ...
        catch
        {
            ...
            MessageBox.Show("Not in the right directory bucko, it goes here.\nAfter I close, would you be a doll and move me there?", "Oculus Kill Switch", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        try
        {
